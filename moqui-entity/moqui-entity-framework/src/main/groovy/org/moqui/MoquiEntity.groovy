...
public class MoquiEntity {
    ...
    private static EntityExecutionContextFactory activeExecutionContextFactory = null;

    private static final ServiceLoader<EntityExecutionContextFactory> executionContextFactoryLoader =
            ServiceLoader.load(EntityExecutionContextFactory.class);
    static {
    ...
    public static void dynamicInit(EntityExecutionContextFactory executionContextFactory) {
    ...
    public static <K extends EntityExecutionContextFactory> K dynamicInit(Class<K> ecfClass, ServletContext sc)
    ...
    public static <K extends EntityExecutionContextFactory> K dynamicReInit(Class<K> ecfClass, ServletContext sc)
            throws InstantiationException, IllegalAccessException {
    ...
    public static EntityExecutionContextFactory getExecutionContextFactory() { return activeExecutionContextFactory; }
    
    public static ExecutionContext getExecutionContext() {
        return activeExecutionContextFactory.getExecutionContext();
    }

    static EntityFacade getEntity() {
        return getExecutionContextFactory().getEntity()
    }
