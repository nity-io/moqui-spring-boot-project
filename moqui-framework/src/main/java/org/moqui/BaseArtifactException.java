...
public class BaseArtifactException extends BaseException {
    ...
    private void populateArtifactStack() {
        //EntityExecutionContextFactory ecf = MoquiEntity.getExecutionContextFactory();
        //if (ecf != null){
        //    EntityExecutionContext executionContext = (EntityExecutionContext)ecf.getExecutionContext();
        //    artifactStack = executionContext.getArtifactExecution().getStack();
        //}
    }
