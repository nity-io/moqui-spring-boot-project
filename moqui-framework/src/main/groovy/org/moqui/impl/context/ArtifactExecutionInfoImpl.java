...
public class ArtifactExecutionInfoImpl implements ArtifactExecutionInfo {
    ...
    private ArtifactExecutionInfo parentAeii = (ArtifactExecutionInfo) null;
    public final long startTimeMillis;
    public final long startTimeNanos;
    private long endTimeNanos = 0;
    public Long outputSize = null;
    private ArrayList<ArtifactExecutionInfo> childList = (ArrayList<ArtifactExecutionInfo>) null;
    ...
    @Override
    public void calcChildTime(boolean recurse) {
        childrenRunningTime = 0;
        if (childList != null) for (ArtifactExecutionInfo aeii: childList) {
    ...
    @Override
    public void setParent(ArtifactExecutionInfo parentAeii) { this.parentAeii = parentAeii; }
    @Override
    ...
    void addChild(ArtifactExecutionInfo aeii) {
    ...
    public void print(Writer writer, int level, boolean children) {
        try {
            ...
            if (children && childList != null)
                for (ArtifactExecutionInfo aeii: childList) aeii.print(writer, level + 1, true);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    static List<Map<String, Object>> hotSpotByTime(List<ArtifactExecutionInfo> aeiiList, boolean ownTime, String orderBy) {
        Map<String, Map<String, Object>> timeByArtifact = new LinkedHashMap<>();
        for (ArtifactExecutionInfo aeii: aeiiList) aeii.addToMapByTime(timeByArtifact, ownTime);
    ...
    @SuppressWarnings("unchecked")
    @Override
    public void addToMapByTime(Map<String, Map<String, Object>> timeByArtifact, boolean ownTime) {
        ...
        if (childList != null) for (ArtifactExecutionInfo aeii: childList) aeii.addToMapByTime(timeByArtifact, ownTime);
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public void consolidateArtifactInfo(List<Map> topLevelList, Map<String, Map<String, Object>> flatMap, Map parentArtifactMap) {
        String key = getKeyString();
        ...
        if (childList != null) for (ArtifactExecutionInfo aeii: childList) aeii.consolidateArtifactInfo(topLevelList, flatMap, artifactMap);
    }
    ...
    public static class ArtifactAuthzCheck {
        ...
        public ArtifactAuthzCheck(Map aacvEvb) {
            Map<String, Object> aacvMap = aacvEvb;
