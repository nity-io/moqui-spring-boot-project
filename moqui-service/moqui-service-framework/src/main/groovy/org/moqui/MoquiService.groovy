...
public class MoquiService {
    ...
    private static final ServiceLoader<ServiceExecutionContextFactory> executionContextFactoryLoader =
            ServiceLoader.load(ServiceExecutionContextFactory.class);
    static {
