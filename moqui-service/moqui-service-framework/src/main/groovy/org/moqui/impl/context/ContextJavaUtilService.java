...
public class ContextJavaUtilService {
    protected final static Logger logger = LoggerFactory.getLogger(ContextJavaUtilService.class);
    ...
    public static class ArtifactHitInfo {
        ...
        ArtifactHitInfo(ExecutionContext eci, boolean isSlowHit, ArtifactExecutionInfo.ArtifactType artifactTypeEnum,
    ...
    static {
        ...
        module.addSerializer(GString.class, new ContextJavaUtilService.GStringJsonSerializer());
