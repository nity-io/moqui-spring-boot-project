...
public class ParameterInfo {
    ...
    Object convertType(String namePrefix, Object parameterValue, boolean isString, ExecutionContext eci) {
        ...
        if (parmType != null && isString && !isEmptyString) {
            ...
            switch (parmType) {
                ...
                case BIG_INTEGER:
                    ...
                    if (bdVal == null) {
                        eci.getMessage().addValidationError(null, namePrefix + name, serviceName,
                ...
                case TIME:
                    ...
                    if (converted == null) eci.getMessage().addValidationError(null, namePrefix + name,
    ...
    Object validateParameterHtml(String namePrefix, Object parameterValue, boolean isString, ExecutionContext eci) {
    ...
    private String canonicalizeAndCheckHtml(ServiceDefinition sd, String namePrefix, String parameterValue, ExecutionContext eci) {
