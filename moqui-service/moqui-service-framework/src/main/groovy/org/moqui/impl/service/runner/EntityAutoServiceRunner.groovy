...
class EntityAutoServiceRunner implements ServiceRunner {
    ...
    private ServiceExecutionContextFactoryImpl ecfi = null
    ...
    Map<String, Object> runService(ServiceDefinition sd, Map<String, Object> parameters) {
        ...
        EntityDefinition ed = ecfi.entityFacade.getEntityDefinition(sd.noun)
        ...
        try {
            ...
            if ("create".equals(sd.verb)) {
                createEntity(ecfi, eci, ed, parameters, result, sd.getOutParameterNames())
                ...
                updateEntity(ecfi, eci, ed, parameters, result, sd.getOutParameterNames(), null)
                ...
                deleteEntity(ecfi, eci, ed, parameters)
            } else if ("store".equals(sd.verb)) {
                storeEntity(ecfi, eci, ed, parameters, result, sd.getOutParameterNames())
    ...
    static void createEntity(ServiceExecutionContextFactoryImpl ecfi, ExecutionContext eci, EntityDefinition ed, Map<String, Object> parameters,
                             Map<String, Object> result, ArrayList<String> outParamNames) {
        createRecursive(ecfi, ecfi.entityFacade, ed, parameters, result, outParamNames, null)
    }

    static void createRecursive(ServiceExecutionContextFactoryImpl ecfi, EntityFacadeImpl efi, EntityDefinition ed, Map<String, Object> parameters,
    ...
    protected static void checkStatus(EntityDefinition ed, Map<String, Object> parameters, Map<String, Object> result,
                                      ArrayList<String> outParamNames, EntityValue lookedUpValue, EntityFacade efi) {
        ...
        if (parameterStatusId) {
            ...
            if (lookedUpStatusId && !parameterStatusId.equals(lookedUpStatusId)) {
                ...
                if (statusFlowTransitionList.size() == 0) {
                    ...
                    ExecutionContext eci = MoquiService.getExecutionContext()
                    ...
                    throw new ServiceException(MoquiService.getExecutionContextFactory().resource.expand('StatusFlowTransitionNotFoundTemplate', "",
    ...
    static void updateEntity(ServiceExecutionContextFactoryImpl ecfi, ExecutionContext eci, EntityDefinition ed, Map<String, Object> parameters,
                             Map<String, Object> result, ArrayList<String> outParamNames, EntityValue preLookedUpValue) {
        EntityFacade efi = ecfi.getEntity()
    ...
    static void deleteEntity(ServiceExecutionContextFactoryImpl ecfi, ExecutionContext eci, EntityDefinition ed, Map<String, Object> parameters) {
        ...
        if (hasWildcard) {
            // long deleted =
            ecfi.entityFacade.find(ed.fullEntityName).condition(newParms).deleteAll()
            // logger.info("Deleted ${deleted} ${ed.fullEntityName} records with PK wildcard: ${parameters}")
        } else {
            EntityValue ev = ecfi.entityFacade.makeValue(ed.fullEntityName).setFields(parameters, true, null, true)
            ev.delete()
        }
    }
}
