...
import org.moqui.cache.impl.tools.MCacheToolFactory
...
public class CacheFacadeImpl implements CacheFacade {
    ...
    protected final CacheExecutionContextFactoryImpl ecfi
    ...
    CacheFacadeImpl(CacheExecutionContextFactoryImpl ecfi) {
        this.ecfi = ecfi
