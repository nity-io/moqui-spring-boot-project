...
class MoquiContextListener implements ServletContextListener {
    ...
    protected WebExecutionContextFactoryImpl ecfi = null
...
//            String moquiWebappName = sc.getInitParameter("moqui-name")
            String moquiWebappName = MoquiWeb.WEBAPP_NAME
            ...
            ecfi = MoquiWeb.dynamicInit(WebExecutionContextFactoryImpl.class, sc)
...
//                    sc.addListener(listener)
            ...
            if (wi.afterStartupActions) {
                WebExecutionContext eci = ecfi.getEci()
    ...
    static class MoquiServerEndpointConfigurator extends ServerEndpointConfig.Configurator {
        ...
        WebExecutionContextFactoryImpl ecfi
        Long maxIdleTimeout = null
        MoquiServerEndpointConfigurator(WebExecutionContextFactoryImpl ecfi, String timeoutStr) {
            this.ecfi = ecfi
