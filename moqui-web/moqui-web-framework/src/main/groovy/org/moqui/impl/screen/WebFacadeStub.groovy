...
class WebFacadeStub implements WebFacade {
    ...
    WebFacadeStub(WebExecutionContextFactory ecfi, Map<String, Object> requestParameters,
    ...
    @Override void sendResourceResponse(String location) {
        WebExecutionContext executionContext = (WebExecutionContext) ecfi.getExecutionContext()
        WebFacadeImpl.sendResourceResponseInternal(location, false, executionContext, httpServletResponse)
        /*
