...
abstract class MoquiAbstractEndpoint extends Endpoint implements MessageHandler.Whole<String> {
    ...
    private WebExecutionContextFactory ecfi = (WebExecutionContextFactory) null
    ...
    WebExecutionContextFactory getEcf() { return ecfi }
    ...
    void onOpen(Session session, EndpointConfig config) {
        ...
        ecfi = (WebExecutionContextFactory) config.userProperties.get("executionContextFactory")
...
//                eci.getUser().initFromHandshakeRequest(handshakeRequest)
//            } else if (httpSession != null) {
//                eci.getUser().initFromHttpSession(httpSession)
//            } else {
