...
public class MoquiWeb {
    protected final static Logger logger = LoggerFactory.getLogger(MoquiEntity.class);

    public final static String WEBAPP_NAME = "webroot"

    private static WebExecutionContextFactory activeExecutionContextFactory = null;
    
    public static void dynamicInit(WebExecutionContextFactory executionContextFactory) {
    ...
    public static <K extends WebExecutionContextFactory> K dynamicInit(Class<K> ecfClass, ServletContext sc)
    ...
    public static <K extends WebExecutionContextFactory> K dynamicReInit(Class<K> ecfClass, ServletContext sc)
            throws InstantiationException, IllegalAccessException {
    ...
    public static WebExecutionContextFactory getExecutionContextFactory() { return activeExecutionContextFactory; }
