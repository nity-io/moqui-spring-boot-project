...
<head>
    ...
    <link rel="apple-touch-icon" href="${STATIC_PREFIX}/MoquiLogo100.png"/>
<#-- Style Sheets -->
<#list sri.getThemeValues("STRT_STYLESHEET") as styleSheetLocation>
    <link rel="stylesheet" href="${STATIC_PREFIX}${styleSheetLocation}" type="text/css">
</#list>
...
<#list html_scripts?if_exists as scriptLocation>
    <script src="${STATIC_PREFIX}${scriptLocation}" type="text/javascript"></script>
</#list>
...
<#list sri.getThemeValues("STRT_SHORTCUT_ICON") as iconLocation>
    <link rel="shortcut icon" href="${STATIC_PREFIX}${iconLocation}">
</#list>
</head>
