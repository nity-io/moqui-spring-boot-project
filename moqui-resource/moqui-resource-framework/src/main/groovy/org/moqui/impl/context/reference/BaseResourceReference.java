...
public abstract class BaseResourceReference extends ResourceReference {
    ...
    protected ResourceExecutionContextFactoryImpl ecf = (ResourceExecutionContextFactoryImpl) null;

    public BaseResourceReference() { }

    @Override
    public ResourceReference init(String location) { return init(location, null); }
    public abstract ResourceReference init(String location, ResourceExecutionContextFactoryImpl ecf);
