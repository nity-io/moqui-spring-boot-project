...
public class FtlTemplateRenderer implements TemplateRenderer {
    ...
    public TemplateRenderer init(ResourceExecutionContextFactory ecf) {
    ...
    public void render(String location, Writer writer) {
        ...
        try {
            theTemplate.createProcessingEnvironment(ecfi.getEci().getContext(), writer).process();
        } catch (Exception e) {
    ...
    private static Configuration makeFtlConfiguration(ResourceExecutionContextFactoryImpl ecfi) {
    ...
    private static class MoquiConfiguration extends Configuration {
        ...
        MoquiConfiguration(Version version, ResourceExecutionContextFactoryImpl ecfi) {
            super(version);
            this.ecfi = ecfi;
        }
        ...
        public ResourceExecutionContextFactoryImpl getEcfi() { return ecfi; }
        public void setEcfi(ResourceExecutionContextFactoryImpl ecfi) { this.ecfi = ecfi; }
    }
