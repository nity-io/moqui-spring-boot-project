...
class ContentResourceReference extends BaseResourceReference {
    ...
    @Override ResourceReference init(String location, ResourceExecutionContextFactoryImpl ecf) {
        this.ecf = ecf
    ...
    ResourceReference init(String repositoryName, javax.jcr.Node node, ResourceExecutionContextFactoryImpl ecf) {
        this.ecf = ecf
