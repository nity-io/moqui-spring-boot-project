...
public class XmlAction {
    ...
    protected final ResourceExecutionContextFactory ecfi;
    ...
    public XmlAction(ResourceExecutionContextFactory ecfi, MNode xmlNode, String location) {
        this.ecfi = ecfi;
        this.xmlNode = xmlNode;
        this.location = location;
    }

    public XmlAction(ResourceExecutionContextFactoryImpl ecfi, String xmlText, String location) {
        this.ecfi = ecfi;
        this.location = location;
    ...
    public Object run(ExecutionContext eci) {
    ...
    public boolean checkCondition(ExecutionContext eci) {
    ...
    public String getGroovyString() {
        ...
        try {
            ...
            XmlActionsScriptRunner xmlActionsScriptRunner = (XmlActionsScriptRunner)ecfi.getResource().getXmlActionsScriptRunner();
            Environment env = xmlActionsScriptRunner.getXmlActionsTemplate().createProcessingEnvironment(root, outWriter);
            env.process();
