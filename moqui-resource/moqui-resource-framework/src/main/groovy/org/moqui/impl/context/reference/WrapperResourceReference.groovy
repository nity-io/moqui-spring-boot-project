...
abstract class WrapperResourceReference extends BaseResourceReference {
    ...
    @Override
    ResourceReference init(String location, ResourceExecutionContextFactoryImpl ecf) {
        this.ecf = ecf
        return this
    }
    ResourceReference init(ResourceReference rr, ResourceExecutionContextFactoryImpl ecf) {
        this.rr = rr
        this.ecf = ecf
        return this
    }
